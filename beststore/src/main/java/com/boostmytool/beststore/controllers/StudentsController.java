...
public class StudentsController {
	...
	// 	if (isAdmin) {
	// 		return "students/admin";  // Assuming there is a separate admin view
	// 	} else if (isUser) {
	// 		return "students/index";
	// 	} else {
	...
	public String showStudentList(Model model, Authentication authentication) {
		...
		return isAdmin ? "students/admin" : "students/index";  // ensure the view name matches the HTML file name
	}
